...
/***/ function(module, exports, __webpack_require__) {
	...
	_.extend(Backbone.Validation.callbacks, {
	  valid: function(view, attr, selector) {
	    ...
	    return view.$('.help-block2').html('').addClass('hidden');
	  },
	  invalid: function(view, attr, error, selector) {
	    var $el;
	    $el = view.$('[name=' + attr + ']');
	    if (view.$('.help-block2').html() === '') {
...
/***/ function(module, exports, __webpack_require__) {
	...
	/* WEBPACK VAR INJECTION */(function(Marionette, Backbone) {module.exports = Marionette.Object.extend({
	  ...
	  showSignUp: function() {
	    ...
	    SignUpViewSucces = __webpack_require__(41);
	    signUpViewSucces = new SignUpViewSucces();
	    SignUpView = __webpack_require__(39);
