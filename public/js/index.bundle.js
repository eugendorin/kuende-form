...
/***/ function(module, exports, __webpack_require__) {
	...
	/* WEBPACK VAR INJECTION */(function(Marionette, Backbone) {var app;
...
/***/ function(module, exports, __webpack_require__) {
	...
	(function(root, factory) {
	  ...
	  if (true) {
	    !(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(2), __webpack_require__(5), __webpack_require__(6), __webpack_require__(7)], __WEBPACK_AMD_DEFINE_RESULT__ = function(Backbone, _) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	(function(root, factory) {
	  ...
	  if (true) {
	    !(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(2), __webpack_require__(5)], __WEBPACK_AMD_DEFINE_RESULT__ = function(Backbone, _) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		...
		if(!content.locals) {
			module.hot.accept("!!./../../node_modules/css-loader/index.js!./../../node_modules/stylus-loader/index.js!./sign_up.styl", function() {
				var newContent = require("!!./../../node_modules/css-loader/index.js!./../../node_modules/stylus-loader/index.js!./sign_up.styl");
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, "#form-signup .help-block-color {\n  background-color: #f44336;\n  color: #fff;\n  text-align: center;\n  margin-top: 10px;\n}\n", ""]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	/* WEBPACK VAR INJECTION */(function(Backbone, _) {__webpack_require__(14);
...
/***/ function(module, exports, __webpack_require__) {
	...
	(function (factory) {
	  ...
	  if (true)
	    !(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(15), __webpack_require__(2), exports], __WEBPACK_AMD_DEFINE_FACTORY__ = (factory), __WEBPACK_AMD_DEFINE_RESULT__ = (typeof __WEBPACK_AMD_DEFINE_FACTORY__ === 'function' ? (__WEBPACK_AMD_DEFINE_FACTORY__.apply(exports, __WEBPACK_AMD_DEFINE_ARRAY__)) : __WEBPACK_AMD_DEFINE_FACTORY__), __WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__));
...
/***/ function(module, exports, __webpack_require__) {
	...
	(function (factory) {
	  if (true) {
	    module.exports = factory(__webpack_require__(2), __webpack_require__(17));
...
/***/ function(module, exports, __webpack_require__) {
	...
	/* WEBPACK VAR INJECTION */(function(Marionette) {var Controller;
...
/***/ function(module, exports, __webpack_require__) {
	...
	/* WEBPACK VAR INJECTION */(function(Marionette, Backbone) {module.exports = Marionette.Object.extend({
	  initialize: function() {
	    var Layout;
	    Layout = __webpack_require__(20);
	    this.layout = new Layout();
	    this.layout.on('render', (function(_this) {
	      return function() {
	        _this.showNavbar();
	  ...
	  showNavbar: function() {
	    ...
	    NavbarView = __webpack_require__(41);
	    navbarView = new NavbarView();
	    navbarView.on('handle:navigate', (function(_this) {
	      return function(route) {
	        if (route === 'Rounds') {
	          Backbone.history.navigate('rounds');
	          return _this.showRounds();
	        } else {
	    ...
	    return this.layout.headerRegion.show(navbarView);
	  },
	  showVerifyPhoneNumber: function() {
	    var VerifyPhoneNumberModel, VerifyPhoneNumberView, verifyPhoneNumberModel, verifyPhoneNumberView;
	    Backbone.history.navigate('sign_up_phone');
	    VerifyPhoneNumberModel = __webpack_require__(43);
	    verifyPhoneNumberModel = new VerifyPhoneNumberModel();
	    VerifyPhoneNumberView = __webpack_require__(44);
	    verifyPhoneNumberView = new VerifyPhoneNumberView({
	      model: verifyPhoneNumberModel
	    });
	    return this.layout.contentRegion.show(verifyPhoneNumberView);
	  },
	  showVerifyEmail: function() {
	    var VerifyEmailView, verifyEmailView;
	    Backbone.history.navigate('sign_up_email');
	    VerifyEmailView = __webpack_require__(46);
	    verifyEmailView = new VerifyEmailView();
	    return this.layout.contentRegion.show(verifyEmailView);
	  },
	  showSignUp: function() {
	    var SignUpModel, SignUpView, signUpModel, signUpView;
	    SignUpModel = __webpack_require__(48);
	    signUpModel = new SignUpModel();
	    SignUpView = __webpack_require__(49);
	    signUpView = new SignUpView({
	      model: signUpModel
	    });
	    this.layout.contentRegion.show(signUpView);
	    signUpView.on('handle:submit:signup', (function(_this) {
	      return function() {
	        if (signUpModel.isValid()) {
	          if (Backbone.Validation.patterns.email.test(signUpModel.get('id'))) {
	            return _this.showVerifyEmail();
	          } else {
	            return _this.showVerifyPhoneNumber();
	          }
	        }
	      };
	    })(this));
	    return signUpView.on('handle:focus:loss:input', function(inputName) {
	      return this.model.isValid(inputName);
	    });
	  }
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	/* WEBPACK VAR INJECTION */(function(Marionette) {module.exports = Marionette.LayoutView.extend({
	  el: '#app-hook',
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _handlebarsBase = __webpack_require__(24);
	...
	var _handlebarsException = __webpack_require__(26);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _exception = __webpack_require__(26);
...
/***/ function(module, exports, __webpack_require__) {
	...
	/* WEBPACK VAR INJECTION */(function(Marionette, $) {module.exports = Marionette.ItemView.extend({
	  template: __webpack_require__(42),
	  events: {
	    'click [data-action="link"]': 'eventActionClickLink'
	  },
	  eventActionClickLink: function(ev) {
	    return this.trigger('handle:navigate', $(ev.target).text());
	  }
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	function __default(obj) { return obj && (obj.__esModule ? obj["default"] : obj); }
	module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
	    return "<div class=\"navbar-fixed\">\n  <nav>\n    <div class=\"nav-wrapper\">\n      <a href=\"#!\" class=\"brand-logo\">Logo</a>\n      <ul class=\"right hide-on-med-and-down\">\n        <li><a data-action=\"link\">Players</a></li>\n        <li><a data-action=\"link\">Rounds</a></li>\n      </ul>\n    </div>\n  </nav>\n</div>\n";
	},"useData":true});
...
/***/ function(module, exports, __webpack_require__) {
	...
	/* WEBPACK VAR INJECTION */(function(Backbone) {module.exports = Backbone.Model.extend({
	  ...
	  validation: {
	    required: true,
	    msg: 'You`re probably in a hurry to join, so please enter the correct confirmation code! ;))',
	    pattern: 'number',
	    length: 5
	  }
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
	  ...
	  return "<div id='form-verify-phone'>\n  <h3>Verify Phone Number</h3>\n  <p>You`re one step away from joining!</p>\n\n\n  <p>We have sent a SMS with the confirmation code at "
	    + container.escapeExpression(((helper = (helper = helpers.id || (depth0 != null ? depth0.id : depth0)) != null ? helper : helpers.helperMissing),(typeof helper === "function" ? helper.call(depth0 != null ? depth0 : {},{"name":"id","hash":{},"data":data}) : helper)))
	    + "</p>\n  <form>\n    <input type=\"number\" data-ui=\"input\" name=\"confirm_code\" placeholder=\"enter the 5 letters confirmation code...\" >\n\n    <input class=\"waves-effect waves-light btn\" type=\"submit\" placeholder=\"CONFIRM\">\n    <a>Resend SMS</a>\n    <a>Back to Sign Up</a>\n  </form>\n\n</div>\n";
	},"useData":true});
...
/***/ function(module, exports, __webpack_require__) {
	...
	function __default(obj) { return obj && (obj.__esModule ? obj["default"] : obj); }
	module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
	    return "<div id='form-verify-email'>\n  <h3>Verify Email</h3>\n  <p>You`re one step away from joining!</p>\n\n\n  <p>We`re really excited to have you around, so please check and conform your email address!</p>\n\n  <a>Resend Email</a>\n  <a>Back to Sign Up</a>\n\n</div>\n";
	},"useData":true});
...
/***/ function(module, exports, __webpack_require__) {
	...
	/* WEBPACK VAR INJECTION */(function(Backbone) {module.exports = Backbone.Model.extend({
	  ...
	  validateEmailOrPhone: function(value, attr, computedState) {
	    if ((value != null ? value.search('@') : void 0) > -1) {
	      if (!Backbone.Validation.patterns.email.test(value)) {
	        return 'Please enter a valid email address';
	      }
	    } else {
	      if (!Backbone.Validation.patterns.digits.test(value)) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	/* WEBPACK VAR INJECTION */(function(Marionette, Backbone, $) {module.exports = Marionette.ItemView.extend({
	  ...
	  eventActionSubmit: function(ev) {
	    ev.preventDefault();
	    this.model.validate();
	    this.trigger('handle:submit:signup');
	    return false;
	  },
	  eventFocusInputLoss: function(ev) {
	    return this.trigger('handle:focus:loss:input', $(ev.target).attr('name'));
	  }
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	function __default(obj) { return obj && (obj.__esModule ? obj["default"] : obj); }
	module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
	    return "<div id='form-signup'>\n  <h3>Sign Up</h3>\n  <p>Join our world!</p>\n\n  <form>\n      <input type=\"text\" data-ui=\"input\" name=\"id\" placeholder=\"enter your phone number/email...\" >\n      <input type=\"text\" data-ui=\"input\" name=\"confirm_id\" placeholder=\"enter your phone number/email...\" >\n      <input type=\"password\" data-ui=\"input\" name=\"password\" placeholder=\"enter your password...\" >\n      <input type=\"password\" data-ui=\"input\" name=\"confirm_password\" placeholder=\"confirm your password...\" >\n      <input class=\"waves-effect waves-light btn\" type=\"submit\" placeholder=\"SIGN UP\">\n\n      <div class=\"help-block hidden\"></div>\n\n  </form>\n</div>\n";
	},"useData":true});
